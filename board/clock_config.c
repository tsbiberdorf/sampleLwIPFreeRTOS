...
- {id: SDHCCLK.outFreq, value: 24 MHz}
...
- {id: MCG.PRDIV.scale, value: '10', locked: true}
- {id: MCG.VDIV.scale, value: '50', locked: true}
        ...
        .pll0Config =
            {
                ...
                .prdiv = 0x9U,                    /* PLL Reference divider: divided by 10 */
