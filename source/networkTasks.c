...
static TaskHandle_t  tl_NetworkTaskHandlerId = NULL;
...
static void StartNetworkTasks(void *pvParameters)
{
 ...
 */
void initNetworkTasks()
{
	xTaskCreate(StartNetworkTasks, "Network", 256 , NULL, (configMAX_PRIORITIES-configMAX_PRIORITIES+1), &tl_NetworkTaskHandlerId);
